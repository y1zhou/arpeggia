...
- [x] Reject unequal shapes, non-finite coordinates, and fewer than three
      non-collinear points with typed errors.
- [x] Test identity, translation, rotation, reflection, noise, large offsets,
...
- [x] Fill disjoint contiguous packed-matrix chunks with all requested workers,
...
- [x] Normalize labels and medoid ties deterministically and short-circuit
