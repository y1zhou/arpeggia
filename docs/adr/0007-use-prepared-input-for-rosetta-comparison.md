...
The SASA comparison established improvement over `main` but not numerical
equivalence with Rosetta LeGrand. Selection of the standard SASA definition
remains at the maintainer review checkpoint.
