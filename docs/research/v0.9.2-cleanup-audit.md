...
Chain Groups Specification is under Usage; the Scientific conventions link
follows Development and points to the [conventions and contact decision path](../scientific-conventions.md).
