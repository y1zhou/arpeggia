...
a second numbering engine. Whole-domain conversion checks the upstream rule
windows for both numbering and CDR conventions before counting loop residues;
