...
coordinates. One reference-derived CDR map serves each block; region views derive
from Rust residue records. Python uses native value equality/hash for numbered
