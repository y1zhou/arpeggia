...
CDR band map serves the whole block. Reference position conversion is shared by
...
The [antibody qualification](https://github.com/y1zhou/arpeggia/blob/master/docs/benchmarks/antibody-numbering.md#arpeggia-adapter-qualification)
measures a 2.99% wheel increase over the sequence-alignment parent and unchanged
pairwise alignment calculation time; the shared renderer adds about 4.4 μs per
